...
Die relativ kleine, aber entscheidende Hauptma\"snahme ist im nun eingezeichneten U- bzw. J-Schenkel-Segment zu sehen.
...
Vielmehr k\"onnen beide Strecken nun mit gr\"o\"seren Initialradien auf das neue S\"udsegment abgeleitet werden.
...
\begin{itemize}
	...
	Dies erfolgt dann nur f\"ur eine noch gr\"o\"sere Erweiterbarkeit der operativen M\"oglichkeiten oder der Change f\"ur einen durchgehenden Acht-Betrieb mit z.B. Kindern.
...
\begin{enumerate}
	...
	Dies entspricht so manchem Vorbild von Regionalhalten in Brandenburg - gro\"ser Dank geht an dieser Stelle an meinen Bruder f\"ur die Idee.
	Eine Ausr\"ustung des anderen Au\"sengleises bleibt dennoch m\"oglicht und w\"urde das mittlere Gleis f\"ur Durchfahrten beibehalten.
	...
	Diese wurde mit der zuvor beschriebenen Ma\"snahme erforderlich.
	Zuvor endete das Gleis der \textbf{lokalen Nebenstrecke} im Bahnhof.
\end{enumerate}

Abschlie\"send zeigt Fig.~\ref{img:state3_granitz_modules} eine Einf\"arbung der verschiedenen Ebenen:
\begin{itemize}
	\item Rot: Ebene 0
...
\begin{itemize}
	\item Endpunkt der Trasse von Granitz-Walddorf kommend ist ein kleiner Schattenbahnhof genannt \textit{JWD} (Janz weit drau\"sen)
...
\begin{enumerate}
	...
	$\rightarrow$ als weites Fernziel realisierbar, da hier aktuell ein selbstgebautes, gro\"sfl\"achiges Regal anschlie\"st, von dem entsprechend ein Fach ger\"aumt werden m\"usste
	...
	$\rightarrow$ unrealistisch, da bereits das S\"udsegment mit gro\"ser Sicherheit nicht dauerhaft platziert werden kann
	\item Alternative Ausf\"uhrung der \textbf{Nebenstrecke westliche D\"orfer} \"uber einen nahezu O-Schluss der Segmente.
	Dies erm\"oglicht auch noch verh\"altnism\"a\"sig viel L\"ange f\"ur diese Nebenstrecke.\\
