\ifthenelse{\boolean{INTERNAL_VERSION}}{
	...
	Wirklich zuallererst: Um zu entscheiden, ob man in diesem Dokument \"uberhaupt interessiert ist, liest man sich am Besten das halbseitige Abstract durch (quasi der Buchr\"ucken, Kap.~\ref{sec:abstract}).
