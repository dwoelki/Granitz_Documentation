...
%   %%
%      \hypersetup{
%        pdftitle={Granitz Documentation},
%        pdfauthor={Dominik Woelki},
%        pdfsubject={Story und Entwicklung der Modelleisenbahnanlage Granitz}
%      }
%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textbf{Symbols:}\\
	\begin{tabular}{p{.15\textwidth-2\tabcolsep} p{.1\textwidth-2\tabcolsep} p{.75\textwidth-2\tabcolsep}}
		$\alpha$ & $deg$ & Winkel \\
		$\Delta$ & & Difference \\
		$R1$ & $cm$ & Radius 1, $19.8~cm$ \\
		$R2$ & $cm$ & Radius 2, $22.5~cm$ \\
		$R3$ & $cm$ & Radius 3, $40.0~cm$ \\
		$R4$ & $cm$ & Radius 4, $43.0~cm$ \\
...
\textbf{Abbreviations:}\\
	\begin{tabular}{p{.25\textwidth-2\tabcolsep} p{.75\textwidth-2\tabcolsep}}
	  ...
	  BR & Baureihe \\
		...
		xD & Chat-Emoticon: der Autor lacht gerade \\
		\\
		\\
		\\
		Abb. & Abbildung \\
