...
%% Pakete %%
  ...
  \usepackage[english]{babel}                                                        %% BABEL -> deutsch, neue Rechtschreibung
...
\parbox[t][22cm][t]{12cm}											% parbox = 2.Spalte mit Text
			...
			%
			%----------------------------------------------		
						\vspace{2.5cm}														% Leerzeile vor vertikaler Abstandsangabe notwendig
...
\ifthenelse{\boolean{INTERNAL_VERSION}}{
	...
	\begin{tabular}{||l||}
	\hline
	\textbf{Highlighted text (\hl{this way}) is meant to be for internal version only}\\
	\textbf{and to be removed for version to be published.}
	\\	
	...
	\\
	\\
	\textit{Please give additional comments what to be removed due to classification.}
	\\
	\hline
	\end{tabular}
	\end{table}
